...
const contractAddress = "0x03cF969581AEdEA742506631188130d84e147806"; // OPW on Polygon
                    ...
                    >
                      ...
                      <div className="flex flex-col xl:flex-row gap-5 xl:gap-10 items-center">
                            ...
                            <p className="text-xl text-blue-500 font-bold ">
                              <input 
                                ...
                                onChange={(e) => {
                                  ...
                                  parseFloat(e.target.value) < 0 ? setOpwAmount(0) : setOpwAmount(parseFloat(e.target.value));

                                  parseFloat(e.target.value) > 1000 ? setOpwAmount(1000) : setOpwAmount(parseFloat(e.target.value));

                                } }


                              />
                              <span className="ml-1 text-sm">OPW</span>
                            </p>
                            ...
                            <p className=" text-xl text-zinc-400 font-bold">
                              = {
                                ...
                                fietCurrency === 'USD' ? (
                                  ...
                                  Number(opwAmount * rate).toLocaleString('ja-JP', {
                                    style: 'currency',
                                    currency: 'JPY'
                                  })
                                ) : fietCurrency === 'CNY' ? (
                                  Number(opwAmount * rate).toLocaleString('zh-CN', {
                                    style: 'currency',
                                    currency: 'CNY'
                                  })
                                ) : (
                                  Number(opwAmount * rate).toLocaleString('ko-KR', {
                                    style: 'currency',
                                    currency: 'KRW'
                                  })
                                )
                              ...
                              {fietAmount > 0 && (
                                <div className="text-lg font-semibold text-zinc-400">
                                  {Rate}: {
                                    ...
                                    // currency format
                                    /*
                                    Number((fietAmount / opwAmount).toFixed(2)).toLocaleString('ko-KR', {
                                      style: 'currency',
                                      currency: 'KRW'
                                    })
                                    */
                                    ...
                                    fietCurrency === 'USD' ? (
                                      Number(fietAmount / opwAmount).toLocaleString('en-US', {
                                        style: 'currency',
                                        currency: 'USD'
                                      })
                                    ) : fietCurrency === 'JPY' ? (
                                      Number(fietAmount / opwAmount).toLocaleString('ja-JP', {
                                        style: 'currency',
                                        currency: 'JPY'
                                      })
                                    ) : fietCurrency === 'CNY' ? (
                                      Number(fietAmount / opwAmount).toLocaleString('zh-CN', {
                                        style: 'currency',
                                        currency: 'CNY'
                                      })
                                    ) : (
                                      Number(fietAmount / opwAmount).toLocaleString('ko-KR', {
                                        style: 'currency',
                                        currency: 'KRW'
                                      })
                                    )
                        ...
                        <div className="mt-4 flex flex-row items-center gap-2">
                          <input
                            disabled={!address || opwAmount === 0 || sellOrdering}
                            type="checkbox"
                        ...
                        <textarea
                          ...
                          placeholder="
                            ...
                            After the buyer accepts the order, you must deposit the OPW to escrow within 1 hour.
                            If you do not deposit the OPW to escrow within 1 hour, the order will be expired.
                        ...
                        */}
                        ...
                        <div className="mt-4 text-sm text-zinc-400">
                          ...
                          <div className="h-2 w-2 bg-zinc-400 rounded-full inline-block mr-2"></div>
                          <span>After the buyer accepts the order, you must deposit the OPW to escrow within 1 hour.
                            If you do not deposit the OPW to escrow within 1 hour, the order will be expired.
                          </span>
                        </div>
                        <div className="mt-4 text-sm text-zinc-400">
                        ...
                        <div className="mt-4 flex flex-col gap-2">
                          ...
                          {sellOrdering ? (
                            ...
                            <>
                              ...
                              <button
                                  disabled={!isSeller || !paymentMethod || opwAmount === 0 || agreementPlaceOrder === false}
                                  className={`text-lg text-white px-4 py-2 rounded-md ${!isSeller || !paymentMethod || opwAmount === 0 || agreementPlaceOrder === false ? 'bg-gray-500' : 'bg-green-500'}`}
                                  onClick={() => {
