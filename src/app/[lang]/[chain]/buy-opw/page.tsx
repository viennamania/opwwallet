...
export default function Index({ params }: any) {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
        ...
        /*
        fetch('/api/orderOpw/getAllSellOrdersForBuyer', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        */
        ...
        const fetchSellOrders = async () => {
            ...
            const response = await fetch('/api/orderOpw/getAllSellOrdersForBuyer', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    */
    ...
    const acceptSellOrder = (
      ...
      smsNumber: string,
        ...
        fetch('/api/orderOpw/acceptSellOrder', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
  ...
  useEffect(() => {
    ...
    const cancelTrade = async (orderId: string, index: number) => {
      ...
      const response = await fetch('/api/orderOpw/cancelTradeByBuyer', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
          ...
          */}
          ...
          <div className="flex flex-col items-start justify-center space-y-4">
              ...
              <div className='flex flex-row items-center space-x-4'>
                  ...
                  <div className="text-2xl font-semibold">{Buy_OPW}</div>
                        ...
                        {sellOrders.map((item, index) => (
                          ...
                          `}>
                            ...
                            <td className="p-2">
                              ...
                              <div className="text-sm font-semibold text-white">
                              {Rate}{' '}{Number(item.fietAmount / item.opwAmount).toFixed(2)}
                              </div>
                            </td>
                              ...
                              {item.status === 'accepted' && (
                                ...
                                <div className="mt-4 flex flex-col gap-2 items-center justify-start">
                                  ...
                                  <div className="mt-4 flex flex-row gap-2 items-center justify-start">
                                    ...
                                    <div className="flex flex-col gap-2 items-start">
                                      <span>
                                        {Waiting_for_seller_to_deposit} {item.opwAmount} OPW {to_escrow}...
                                      </span>
