...
export default function Index({ params }: any) {
  ...
  [
    {
        "member_id": "helloworld@gmail.com",
        "store_code": "2000001",
        "dealer_seq": "100000001",
        "txid": "0x0d1868e7eaec64be679f58d68f0e461759ac0754ffe7e7dc22c87de21e47b0a9",
        "regist_date": "2024-09-25 05:54:29",
        "eth_bill": "0.71",
        "txid_time": "1727243668",
        "category": "receive",
        "eth_fee": "0.001562",
        "eth_dealer": "0.10269800000000001",
        "eth_finish": "0.6057400000000001",
        "eth_php": "10.00",
        "eth_php_user": "1350",
        "eth_php_finish": "817.749",
        "other_address": "0x",
        "balance_yn": "Y",
        "ins_date": "2024-09-25 05:54:29",
        "coin_type": "USDT",
        "fee_amount": null,
        "dealer_balance_yn": "Y",
  ...
  */
  const [getPaymentTransactions, setPaymentTransactions] = useState([] as any[]);
  useEffect(() => {

    const fetchPaymentInformations = async () => {

      const response = await fetch('/api/payment/getPaymentTransactions', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      ///console.log('getPaymentInformations data', data);

      // set 5 payment transactions of jsonData.data
            ...
            <div className="mt-5 flex flex-col items-center gap-2 mb-4">
              ...
              <div className=" flex flex-row items-center justify-center gap-2">
                ...
                <span className="text-sm text-white">
                  분쟁 시 본인 지갑 주소가 꼭 필요하므로 본인 지갑 주소를 잘 저장해놓으시기 바랍니다.
                </span>
              </div>



              {/* if balance > 0 then "입금중입니다..." */}
              {/* loading image rotation */}
              {address && balance > 0 && (
                <div className='mt-10 flex flex-row gap-2 items-center justify-center'>
                  {/* loading image */}
                  <Image
                    src="/loading.png"
                    alt="Loading"
              ...
              <div className='w-full xl:w-96 mt-10 flex flex-col gap-2 items-center justify-center'>
                ...
                <div className="mt-10 w-full flex flex-col items-center justify-center gap-2">
                  ...
                  <table className=" w-full table-auto border-collapse border border-zinc-800 rounded-md">
                    ...
                    <tbody>
                      {getPaymentTransactions.map((item, index) => (
                        ...
                        `}>
                          ...
                          <td className="p-2 text-center">
                            <div className="text-sm text-white font-semibold ">
                              {// korean date and time
                                new Date(item.regist_date).toLocaleString('ko-KR')
                              }
                            </div>
                          </td>
                          <td className="p-2 text-right">
                            <div className="text-lg font-semibold text-green-500">
                              {
                                Number(item.eth_bill).toFixed(2)
                              }
                            </div>
                          </td>
                          <td className="p-2 text-right">
                            <div className="text-lg font-semibold text-yellow-500">
                              {
                                Number(item.eth_bill * item.eth_php_user).toFixed(0)
                              }
                            </div>
                          </td>
